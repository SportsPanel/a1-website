    ...
    <section id="about">
      <div className="flex bg-black h-screen bg-[url(./assets/images/bg-image.png)] justify-center">
        <div className="flex flex-col items-center mt-20">
          <p className="text-primary font-light text-5xl flex flex-row">We are A1 Sports</p>
          <p className="text-primary font-light text-5xl">SPORTS INVESTMENT PLATFORM</p>
